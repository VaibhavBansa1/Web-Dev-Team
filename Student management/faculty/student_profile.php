...
<body class="bg-success-subtle">
	...
	<div>
		...
		?>
		<form class="row g-3 ms-5 me-5 mt-3 mb-5 border border-4 border-black fw-semibold" action="student_profile.php" method="post">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				...
				<select id="Branch" class="form-select" name="branch">
					<option value='' selected><?php echo $row['branch_name'] . "--Default"; ?></option>
                    <?php
                        include('../conn.php');
			...
			<div class="col-12">
				<button type="submit" class="btn btn-primary d-grid gap-2 col-6 mx-auto mb-3 mt-3">Edit Student</button>
			</div>
		</form>
	</div>
</body>
