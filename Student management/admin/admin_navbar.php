                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../admin/students_detail.php">Students Data</a></li>
                                <li><a class="dropdown-item" href="../admin/adding_new_student.php">Add Student</a></li>
                            </ul>
                        </li>
                        </li>
                        <li class="nav-item">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../admin/faculty_detail.php">Faculty Data</a></li>
                                <li><a class="dropdown-item" href="../admin/adding_new_faculty.php">Add Faculty</a></li>
                            </ul>
                        </li>
                        <!-- <li class="nav-item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7">
                                        <ul class="list-unstyled">
                                            ...
                                            <hr>
                                            <li><a class="dropdown-item" href="../student/exam_time_table.php">Exam Time
                                                    Tables</a>
                                            </li>
                                            <li><a class="dropdown-item" href="../student/old_exam_papers.php">RGPV
                                                    DIploma
                                                    Papers</a></li>
                                            <!-- More items -->
                                        </ul>
                                    ...
                                    <div class="col-md-5">
                                        <ul class="list-unstyled">
                                            ...
                                            <hr>
                                            <li><a class="dropdown-item" href="../student/time_table.php">Time Table</a>
                                            </li>
                                            <!-- More items -->
                                        </ul>
                                    </div>
